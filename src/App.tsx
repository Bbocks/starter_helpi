    ...
    <div className="App">
      <div>
        <header className='navbar'>
          <button disabled={localStorage.getItem("MYKEY") === null || localStorage.getItem("MYKEY") === ""} className="button" onClick={() => setStatus(  "basic" )}>Basic Assessment</button>
          <button className="button" onClick={() => setStatus( "home" )}>Home</button>
          <button disabled={localStorage.getItem("MYKEY") === null || localStorage.getItem("MYKEY") === ""} className="button" onClick={() => setStatus( "detailed" )}>Detailed Assessment</button>
        </header>
        {status === "home" ? (
